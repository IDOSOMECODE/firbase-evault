...
const Dex: React.FC = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <img style={{ width: "60px", height: "60px", ...styles.image }} src={eVaultLogo} alt="eVault logo" />
      </div>
  ...
  BNB / <div style={{ fontWeight: "bold", textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}>eVault</div>
</div>
